/**
 * This JavaFX application demonstrates the use of the InnerShadow effect.
 * It displays a Text node and two Rectangle nodes, each with a different
 * InnerShadow effect applied to it. The offsets and colors of the inner
 * shadows are varied to show different visual results. The shapes are
 * arranged horizontally, and each shape is accompanied by a text label
 * indicating the offsetX and offsetY properties of its InnerShadow effect.
 */
