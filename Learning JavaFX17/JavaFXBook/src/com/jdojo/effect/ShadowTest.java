/**
 * This JavaFX application demonstrates various uses of the Shadow effect.
 * It showcases three different text effects created using the Shadow class:
 * 1. A simple shadow applied to a Text node.
 * 2. A "Glow" effect, achieved by using a yellow Shadow and layering the original
 *    text on top of the shadowed text within a StackPane.
 * 3. A "DropShadow" effect, created by placing a shadowed Text node behind the
 *    original, un-effected Text node in a StackPane.
 * The application arranges these examples horizontally in an HBox for comparison.
 */
