/**
 * This JavaFX application provides an interactive demonstration of the MotionBlur effect.
 * It displays a Text node with the MotionBlur effect applied. The application also
 * includes two sliders that allow the user to dynamically adjust the 'radius' and 'angle'
 * properties of the MotionBlur effect in real-time. The radius slider controls the length
 * of the blur, while the angle slider controls the direction of the blur. This setup
 * effectively showcases how these two properties influence the appearance of the
 * MotionBlur effect.
 */
