...
public class ComboBoxTest extends Application {
    ...
    public void start(Stage stage){
        ...
        selectionLbl.textProperty().bind(str.concat("Season=").concat(seasons.valueProperty())
                .concat(", Breakfast=").concat(breakfasts.valueProperty()));

        HBox row1 = new HBox(seasonLbl,seasons,breakfastLbl,breakfasts);
        row1.setSpacing(10);
